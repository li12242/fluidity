...
for fileindex in range(1, N+1, 1):
   ...
   probedpressure_upstream = vtktools.vtu.ProbeData(vt, numpy.array([[0.0, 1.35 - 0.11, 0]]), 'Gas::PressureProjected')
   probedpressure_downstream = vtktools.vtu.ProbeData(vt, numpy.array([[0.0, 1.37 + 0.043, 0]]), 'Gas::PressureProjected') #0.718
