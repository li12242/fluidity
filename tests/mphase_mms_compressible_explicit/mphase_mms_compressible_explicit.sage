...
tau_xx1 = mu1*diff(u1,x)            
tau_yy1 = mu1*diff(v1,y)
tau_xy1 = mu1*diff(u1,y)
tau_yx1 = mu1*diff(v1,x)  

tau_xx2 = mu2*diff(u2,x)            
tau_yy2 = mu2*diff(v2,y)
tau_xy2 = mu2*diff(u2,y)
tau_yx2 = mu2*diff(v2,x)  
