...
def forcing_ie1(X):
    return (-0.500*cos(3*X[0]**2*X[1]) + 1.10)*(0.100*cos(X[0]**2 + X[1]**2) + 0.0500)*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(1.25*X[0] - sin(X[0] + X[1])) + (-0.500*cos(3*X[0]**2*X[1]) + 1.10)*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(sin(X[0]**2 + X[1]**2) + 0.500)*(1.25*X[1] - sin(X[0] + X[1]))
